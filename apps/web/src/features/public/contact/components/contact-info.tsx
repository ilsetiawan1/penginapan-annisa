  ...
  return (
    <div className="space-y-4 text-left">
          ...
          <li className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-slate-600 leading-relaxed">
                Jl. Bandara Pattimura, Tawiri, Ambon, Maluku (750 meter dari
                gerbang bandara).
              </p>
            </div>
          </li>
      ...
      <div className="bg-purple-50/90 rounded-2xl p-4 border border-purple-100 text-xs text-slate-700">
        ...
        <p className="text-slate-600 leading-relaxed">
          Keluar dari terminal Bandara Pattimura ➔ Jalan lurus 500m ➔ Belok
          kanan di gapura Tawiri ➔ Penginapan Annisa 250m di sebelah kiri jalan.
        </p>
      </div>
    </div>
  );
