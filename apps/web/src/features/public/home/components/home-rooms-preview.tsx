...
const FEATURED_ROOMS_COLLECTION: FeaturedRoom[] = [
  {
    ...
    priceNum: 275000,
    dp: "Rp 137.500",
    desc: "1 Kasur Besar muat 2–3 tamu, AC dingin nyaman, kamar mandi dalam pribadi, TV & WiFi kencang.",
    image: "/rooms/room-ac-101.jpg",
  },
  {
    id: "A2",
    name: "Kamar A2 — Tipe AC Favorit",
    typeLabel: "Tipe AC Dingin",
    price: "Rp 275.000",
    priceNum: 275000,
    dp: "Rp 137.500",
    desc: "Unit favorit transit, 1 kasur besar empuk, AC dingin, toilet pribadi, TV LED & meja kerja.",
    image: "/rooms/room-ac-102.jpg",
  },
  {
    id: "A3",
    name: "Kamar A3 — Tipe Kipas Hemat",
    typeLabel: "Tipe Kipas Hemat",
    price: "Rp 200.000",
    priceNum: 200000,
    dp: "Rp 100.000",
    desc: "Pilihan hemat & nyaman, 1 kasur besar, kipas angin dinding sejuk, kamar mandi dalam & WiFi.",
