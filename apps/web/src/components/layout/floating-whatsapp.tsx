  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="relative w-14 h-14 bg-emerald-600 hover:bg-emerald-500 text-white rounded-full flex items-center justify-center shadow-lg shadow-emerald-600/35 hover:scale-110 active:scale-95 transition-all duration-300"
      >
