    ...
    <div className="min-h-screen bg-slate-50/50 text-slate-900 selection:bg-brand-100 selection:text-brand-900">
      ...
      <section className="relative pt-28 pb-16 px-4 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center">
          {/* Pill Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-brand-50 border border-brand-200 text-brand-800 text-xs sm:text-sm font-semibold mb-6 shadow-xs animate-in fade-in slide-in-from-bottom-3 duration-500">
          ...
          <h1 className="text-4xl sm:text-6xl font-black text-slate-900 tracking-tight leading-[1.15] max-w-4xl mx-auto">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-600 via-purple-600 to-brand-800">
              Bandara Pattimura
            </span>
          </h1>
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-4 mt-6 text-xs sm:text-sm font-medium text-slate-600">
            <div className="flex items-center gap-1.5 bg-white/80 backdrop-blur px-3 py-1.5 rounded-full border border-slate-200 shadow-2xs">
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-white via-brand-50/30 to-white border-y border-slate-100">
        <div className="max-w-6xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <Badge variant="lilac" className="mb-3">
              Keunggulan Kami
            </Badge>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Card 1 */}
            <Card className="hover:border-brand-300 hover:shadow-lg transition-all group">
              <div className="w-12 h-12 rounded-2xl bg-brand-50 text-brand-700 flex items-center justify-center mb-5 group-hover:scale-110 transition-transform">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-12 bg-white rounded-3xl p-6 border border-slate-200/80 shadow-xs text-center">
            <div>
              <p className="text-3xl sm:text-4xl font-black text-brand-700">750m</p>
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-500 font-medium mt-1">4 AC & 4 Kipas</p>
            </div>
            <div>
              <p className="text-3xl sm:text-4xl font-black text-emerald-600">24 Jam</p>
            ...
            >
              <div>
                ...
                <div className="p-6 sm:p-8">
                  ...
                  <div className="flex items-baseline gap-2 mb-4">
                    ...
                    <span className="text-xs font-semibold text-emerald-700 bg-emerald-50 border border-emerald-200 px-2 py-0.5 rounded-full ml-auto">
              ...
              <div className="p-6 pt-0">
                <Button
                  ...
                  variant="primary"
                  size="lg"
                  className="w-full justify-center gap-2 rounded-2xl shadow-brand-600/20 font-bold text-sm"
                >
                  <a
      ...
      <section id="panduan" className="py-20 px-4 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {articles.map((art) => (
            <Card
              key={art.slug}
              className="hover:border-brand-300 hover:shadow-lg transition-all p-6 flex flex-col justify-between"
            >
              <div>
                <div className="flex items-center justify-between text-xs text-slate-400 mb-3 font-medium">
                  <span className="text-brand-700 font-bold bg-brand-50 px-2.5 py-0.5 rounded-full border border-brand-200">
                    {art.category}
                  </span>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <Button asChild variant="primary" size="lg" className="rounded-2xl gap-2 font-bold">
                <a
