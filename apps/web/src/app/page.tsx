...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#faf9fc] text-slate-900 selection:bg-purple-200 selection:text-purple-900 font-sans">
      <Navbar />

      {/* Hero Section: Clean Acrylic Split Screen */}
      <section className="relative pt-24 sm:pt-32 pb-5 sm:pb-10 px-4 max-w-6xl mx-auto">
      ...
      {/* Kenapa Memilih Penginapan Annisa? (Direct Minimalist Stack) */}
      <section className="py-4 sm:py-6 px-4 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2 sm:gap-4">
          {whyChooseUs.map((item) => {
            ...
            return (
              <div
                key={item.title}
                className="bg-white/95 backdrop-blur-md p-3 sm:p-4 rounded-xl sm:rounded-2xl border border-slate-200/90 shadow-2xs hover:border-purple-300 transition-all flex items-start gap-2.5 sm:flex-col sm:justify-between group"
              >
                <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-purple-50 text-purple-700 flex items-center justify-center shadow-2xs shrink-0 mt-0.5 sm:mt-0 sm:mb-2 group-hover:bg-purple-700 group-hover:text-white transition-colors">
      ...
      <section className="py-4 sm:py-6 px-4 max-w-3xl mx-auto">
