...
Fase 2 bertujuan untuk melakukan dekomposisi komponen secara modular (*high cohesion, loose coupling*) dengan pendekatan **Dual-Zone Feature-Driven Architecture (`src/features/`)**:
1. **Zona 1 (Public Portal):** 5 halaman publik tamu (*Beranda, /kamar, /oleh-oleh, /artikel, /contact*) $\rightarrow$ **[SELESAI ✅]**
...
* **Ukuran Tombol Sentuh Lebar (*Touch Target $\ge 44\text{px}$*):** Tombol aksi (*Check-In, Check-Out, Nota WA, Status Bersih*) sangat mudah ditekan dengan jari tanpa salah pencet.
