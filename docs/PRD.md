...
| **Produk Etalase**      | Makanan Khas Maluku (_Kue Bagea, Roti Kenari, Halua Kenari_) & _Minyak Kayu Putih Asli Namlea/Ambon_               |
| **Target Biaya Server** | **Hemat & Terjangkau** (Self-Hosted VPS Ubuntu + PostgreSQL + ImageKit CDN Free 24/7)                              |
...
1. **Pencatatan Kamar Masih Manual:** Sering memicu kebingungan ketersediaan kamar dan risiko _double booking_ saat ada penumpang transit dadakan.
...
- **Website Publik Responsif:** Menonjolkan pesan utama _"Penginapan Transit Terdekat dari Bandara Pattimura Ambon — 750m, Bebas Ketinggalan Pesawat"_.
...
- **Kebijakan DP 50% Anti-Ghost Booking:** Tamu mentransfer DP 50% dan mengirim bukti transfer $\rightarrow$ staf klik 1 tombol konfirmasi di dashboard $\rightarrow$ kamar otomatis terkunci (_Booked_).
- **Core PMS Super Simpel:** Dashboard berbasis kartu warna (🟩 _Siap_, 🟦 _Terisi_, 🟨 _Perlu Bersih_, 🟥 _Perbaikan_) dengan alur check-in kilat < 1 menit.
...
- **Waktu Check-in:** **Fleksibel (24 Jam)**. Tamu yang datang pagi (misal jam 09:00 WIT) diperbolehkan langsung check-in jika kamar berstatus _Ready/Siap Pakai_.
...
### 3.1. Deskripsi Peran Pengguna (_User Roles_)
...
| **Staf (Resepsionis)**        | Staf operasional yang menerima tamu di lokasi dan menjaga perputaran kamar. | Input tamu _walk-in_ cepat, konfirmasi bukti DP 50%, ubah status _Check-in/Check-out_, update kebersihan kamar (_Siap Pakai $\leftrightarrow$ Perlu Bersih_), dan kirim nota digital ke WhatsApp tamu. |
| **Owner**                     | Pemilik penginapan dengan kepemilikan dan kendali manajerial penuh.         | Semua akses staf + manajemen kamar & tarif, manajemen foto ImageKit, manajemen etalase oleh-oleh & CMS artikel, rekapitulasi laporan reservasi/keuangan, serta kelola akun staf.                       |

---

### 3.2. Matriks Hak Akses (_RBAC Permission Matrix_)
...
| Input Tamu _Fast-Track Walk-in_ (< 1 Menit)     |     ❌ No      |   ✅ Full    |     ✅ Full      |
...
| Upload & Ganti Foto Kamar (ImageKit)            |     ❌ No      |    ❌ No     |     ✅ Full      |
...
│
├── 3. CMS KONTEN & MEDIA
│   ├── Upload & Kompresi Foto Kamar (ImageKit CDN)
...
### 5.2. Alur Tamu Datang Langsung (_Walk-in Receptionist_)
...
### 6.1. Karakteristik Antarmuka Mobile (_App-Like Experience_)
...
- **Instant Touch Feedback:** Menghilangkan delay sentuhan 300ms (_touch-action: manipulation_) agar transisi tombol terasa instan seperti aplikasi native.
...
- **Installable to Homescreen:** Staf resepsionis dan owner dapat menambahkan ikon _Penginapan Annisa PMS_ langsung ke layar utama (_Homescreen_) smartphone Android maupun iOS tanpa perlu mendownload dari Google Play Store / App Store.
- **Standalone Display:** Saat dibuka dari Homescreen, aplikasi berjalan dalam mode _standalone_ (bebas dari address bar browser) sehingga area kerja operasional kamar terlihat jauh lebih luas dan bersih.

---

## 7. ⚙️ Referensi Dokumen Spesifikasi Teknis (TSD & TRD)

> 📘 **Dokumen Teknis Terkait:**
> Seluruh rincian arsitektur teknis sistem, flowchart Mermaid lengkap, ERD PostgreSQL, kontrak endpoint REST API, integrasi ImageKit CDN, dan **Rencana Fase Implementasi Proyek (7-Stage Workflow)** dapat dilihat secara lengkap pada dokumen:
> 👉 **[TSD (Technical Specification Document)](./TSD.md)** dan **[TRD (Technical Requirements Document)](./TRD.md)**
